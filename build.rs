//! Copies `memory.x` next to the linker search path and generates the Vial
//! config (`VIAL_KEYBOARD_DEF` / `VIAL_KEYBOARD_ID`) consumed by RMK.
...
fn generate_vial_config() {
    ...
    // Vial keyboard UID. Replace with your own unique 8 bytes if you ship many.
